...
{
    /// <inheritdoc />
    public partial class WindingBlog : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SavedBlogId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    BlogId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SavedBlogs", x => x.SavedBlogId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BlogTags_TagDefinitions_TagDefinitionId",
                        column: x => x.TagDefinitionId,
                        principalTable: "TagDefinitions",
                        principalColumn: "TagDefinitionId",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogTags_TagDefinitionId",
                table: "BlogTags",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TagDefinitions_TagName",
